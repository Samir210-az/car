        ...
        const VinDatabase = {
            ...
            models: {
                'Honda': {
                    'Accord': { years: yrs(2008, 2026) },
                    'Civic': { years: yrs(2006, 2026) },
                    'CR-V': { years: yrs(2007, 2026) },
                    'Pilot': { years: yrs(2009, 2026) },
                },
                'Toyota': {
                    'Camry': { years: yrs(2007, 2026) },
                    'Corolla': { years: yrs(2008, 2026) },
                    'RAV4': { years: yrs(2006, 2026) },
                    'Land Cruiser': { years: yrs(2008, 2026) },
                    'Prado': { years: yrs(2009, 2026) },
                },
                'BMW': {
                    '3 Series': { years: yrs(2005, 2026) },
                    '5 Series': { years: yrs(2005, 2026) },
                    'X5': { years: yrs(2007, 2026) },
                    'X3': { years: yrs(2006, 2026) },
                },
                'Mercedes-Benz': {
                    'C-Class': { years: yrs(2007, 2026) },
                    'E-Class': { years: yrs(2006, 2026) },
                    'S-Class': { years: yrs(2006, 2026) },
                    'GLE': { years: yrs(2015, 2026) },
                },
                'Ford': {
                    'Focus': { years: yrs(2005, 2026) },
                    'Fiesta': { years: yrs(2008, 2026) },
                    'Explorer': { years: yrs(2006, 2026) },
                    'Kuga': { years: yrs(2008, 2026) },
                },
                'Chevrolet': {
                    'Malibu': { years: yrs(2008, 2026) },
                    'Cruze': { years: yrs(2009, 2026) },
                    'Tahoe': { years: yrs(2007, 2026) },
                    'Lacetti': { years: yrs(2004, 2013) },
                },
                'Nissan': {
                    'Altima': { years: yrs(2007, 2026) },
                    'Rogue': { years: yrs(2008, 2026) },
                    'Qashqai': { years: yrs(2007, 2026) },
                    'Patrol': { years: yrs(2006, 2026) },
                },
                'Volkswagen': {
                    'Golf': { years: yrs(2006, 2026) },
                    'Passat': { years: yrs(2005, 2026) },
                    'Tiguan': { years: yrs(2008, 2026) },
                    'Polo': { years: yrs(2009, 2026) },
                },
                'Audi': {
                    'A4': { years: yrs(2005, 2026) },
                    'A6': { years: yrs(2005, 2026) },
                    'Q5': { years: yrs(2009, 2026) },
                    'Q7': { years: yrs(2006, 2026) },
                },
                'Hyundai': {
                    'Elantra': { years: yrs(2006, 2026) },
                    'Sonata': { years: yrs(2006, 2026) },
                    'Tucson': { years: yrs(2005, 2026) },
                    'Santa Fe': { years: yrs(2007, 2026) },
                },
                'Kia': {
                    'Optima': { years: yrs(2006, 2026) },
                    'Sportage': { years: yrs(2005, 2026) },
                    'Rio': { years: yrs(2006, 2026) },
                    'Sorento': { years: yrs(2009, 2026) },
                },
                'Mazda': {
                    'Mazda3': { years: yrs(2006, 2026) },
                    'Mazda6': { years: yrs(2006, 2026) },
                    'CX-5': { years: yrs(2013, 2026) },
                },
                'Subaru': {
                    'Impreza': { years: yrs(2005, 2026) },
                    'Outback': { years: yrs(2005, 2026) },
                    'Forester': { years: yrs(2008, 2026) },
                },
                'Lexus': {
                    'ES': { years: yrs(2006, 2026) },
                    'RX': { years: yrs(2006, 2026) },
                    'GX': { years: yrs(2010, 2026) },
                    'LX': { years: yrs(2008, 2026) },
                },
                'Volvo': {
                    'S60': { years: yrs(2005, 2026) },
                    'XC60': { years: yrs(2008, 2026) },
                    'XC90': { years: yrs(2005, 2026) },
                },
                'Renault': {
                    'Clio': { years: yrs(2005, 2026) },
                    'Megane': { years: yrs(2005, 2026) },
                    'Duster': { years: yrs(2010, 2026) },
                    'Logan': { years: yrs(2005, 2026) },
                },
                'Peugeot': {
                    '208': { years: yrs(2012, 2026) },
                    '308': { years: yrs(2007, 2026) },
                    '3008': { years: yrs(2009, 2026) },
                    '508': { years: yrs(2010, 2026) },
                },
                'Fiat': {
                    '500': { years: yrs(2007, 2026) },
                    'Doblo': { years: yrs(2010, 2026) },
                    'Tipo': { years: yrs(2015, 2026) },
                },
                'Jaguar': {
                    'XF': { years: yrs(2007, 2026) },
                    'F-Pace': { years: yrs(2016, 2026) },
                },
                'Land Rover': {
                    'Discovery': { years: yrs(2005, 2017) },
                    'Range Rover': { years: yrs(2005, 2026) },
                    'Range Rover Sport': { years: yrs(2005, 2026) },
                },
                'Porsche': {
                    '911': { years: yrs(2005, 2026) },
                    'Cayenne': { years: yrs(2005, 2026) },
                    'Macan': { years: yrs(2014, 2026) },
                },
                'Tesla': {
                    'Model 3': { years: yrs(2017, 2026) },
                    'Model S': { years: yrs(2012, 2026) },
                    'Model Y': { years: yrs(2020, 2026) },
                },
                'Citroën': {
                    'C4': { years: yrs(2005, 2026) },
                    'Berlingo': { years: yrs(2005, 2026) },
                    'C5': { years: yrs(2005, 2017) },
                },
                'Ferrari': {
                    '488': { years: yrs(2015, 2026) },
                    'Portofino': { years: yrs(2018, 2026) },
                    'Roma': { years: yrs(2020, 2026) },
                },
                'Maserati': {
                    'Ghibli': { years: yrs(2013, 2026) },
                    'Levante': { years: yrs(2016, 2026) },
                },
                'Skoda': {
                    'Octavia': { years: yrs(2005, 2026) },
                    'Superb': { years: yrs(2008, 2026) },
                    'Fabia': { years: yrs(2007, 2026) },
                    'Kodiaq': { years: yrs(2017, 2026) },
                },
                'Seat': {
                    'Leon': { years: yrs(2005, 2026) },
                    'Ibiza': { years: yrs(2008, 2026) },
                },
                'Opel': {
                    'Astra': { years: yrs(2005, 2026) },
                    'Corsa': { years: yrs(2006, 2026) },
                    'Insignia': { years: yrs(2009, 2026) },
                },
                'MINI': {
                    'Cooper': { years: yrs(2007, 2026) },
                    'Countryman': { years: yrs(2010, 2026) },
                },
                'Alfa Romeo': {
                    'Giulia': { years: yrs(2016, 2026) },
                    'Stelvio': { years: yrs(2017, 2026) },
                },
                'Dacia': {
                    'Duster': { years: yrs(2010, 2026) },
                    'Logan': { years: yrs(2005, 2026) },
                    'Sandero': { years: yrs(2008, 2026) },
                },
                'Infiniti': {
                    'Q50': { years: yrs(2013, 2026) },
                    'QX60': { years: yrs(2013, 2026) },
                },
                'Acura': {
                    'TLX': { years: yrs(2014, 2026) },
                    'MDX': { years: yrs(2006, 2026) },
                },
                'Genesis': {
                    'G80': { years: yrs(2016, 2026) },
                    'GV80': { years: yrs(2020, 2026) },
                },
                'Chrysler': {
                    '300': { years: yrs(2005, 2026) },
                },
                'Dodge': {
                    'Charger': { years: yrs(2006, 2026) },
                    'Challenger': { years: yrs(2008, 2026) },
                },
                'Jeep': {
                    'Grand Cherokee': { years: yrs(2005, 2026) },
                    'Wrangler': { years: yrs(2005, 2026) },
                    'Compass': { years: yrs(2007, 2026) },
                },
                'Cadillac': {
                    'Escalade': { years: yrs(2007, 2026) },
                    'CTS': { years: yrs(2008, 2019) },
                },
                'GMC': {
                    'Yukon': { years: yrs(2007, 2026) },
                    'Sierra': { years: yrs(2007, 2026) },
                },
                'Buick': {
                    'Enclave': { years: yrs(2008, 2026) },
                },
                'Lincoln': {
                    'Navigator': { years: yrs(2007, 2026) },
                },
                'Bentley': {
                    'Continental GT': { years: yrs(2005, 2026) },
                },
                'Rolls-Royce': {
                    'Phantom': { years: yrs(2005, 2026) },
                    'Ghost': { years: yrs(2010, 2026) },
                },
                'Lamborghini': {
                    'Huracan': { years: yrs(2014, 2026) },
                    'Urus': { years: yrs(2018, 2026) },
                },
                'Aston Martin': {
                    'DB11': { years: yrs(2016, 2026) },
                    'Vantage': { years: yrs(2005, 2026) },
                },
                'McLaren': {
                    '570S': { years: yrs(2015, 2026) },
                },
                'Smart': {
                    'ForTwo': { years: yrs(2007, 2026) },
                },
                'Isuzu': {
                    'D-Max': { years: yrs(2007, 2026) },
                    'NPR': { years: yrs(2005, 2026) },
                },
                'Mitsubishi': {
                    'Lancer': { years: yrs(2007, 2017) },
                    'Outlander': { years: yrs(2006, 2026) },
                    'Pajero': { years: yrs(2006, 2021) },
                },
                'Suzuki': {
                    'Vitara': { years: yrs(2015, 2026) },
                    'Swift': { years: yrs(2005, 2026) },
                },
                'SsangYong': {
                    'Rexton': { years: yrs(2006, 2026) },
                    'Korando': { years: yrs(2010, 2026) },
                },
                'Daewoo': {
                ...
                'Lada': {
                    'Granta': { years: yrs(2011, 2026) },
                    'Vesta': { years: yrs(2015, 2026) },
                    'Niva': { years: yrs(2005, 2026) },
                },
                'GAZ': {
                    'Gazelle': { years: yrs(2005, 2026) },
                },
                'UAZ': {
                    'Patriot': { years: yrs(2005, 2026) },
                },
                'Chery': {
                    'Tiggo': { years: yrs(2015, 2026) },
                },
                'Geely': {
                    'Coolray': { years: yrs(2019, 2026) },
                    'Emgrand': { years: yrs(2016, 2026) },
                },
                'Haval': {
                    'H6': { years: yrs(2017, 2026) },
                    'Jolion': { years: yrs(2020, 2026) },
                },
                'BYD': {
                    'Song': { years: yrs(2019, 2026) },
                    'Han': { years: yrs(2020, 2026) },
                },
                'JAC': {
                    'J7': { years: yrs(2020, 2026) },
                },
                'Changan': {
                    'CS35': { years: yrs(2018, 2026) },
                },
            },
            getMakeFromWMI(wmi) {
        ...
        function generateSampleProducts() {
            ...
            const partNames = {
                'Mühərrik hissələri': ['Şam dəsti', 'Zamanlama kəməri', 'Termostat', 'Su nasosu', 'Yağ nasosu', 'Krank mili', 'Piston dəsti', 'Silindr başlığı', 'Klapan dəsti', 'Mühərrik conta dəsti', 'Kəmər gərginləşdiricisi', 'Kasnak', 'Mühərrik yastığı', 'Yağ soyuducusu', 'Krank mili sensoru', 'Paylayıcı qapağı', 'Piston üzükləri', 'Mühərrik bloku', 'Emiş klapanı', 'Buraxılış klapanı', 'Klapan yayı', 'Klapan gövdəsi keçiricisi', 'Yağ çubuğu (ölçü çubuğu)', 'Turbokompressor', 'Mühərrik dayaq kronşteyni', 'Silindr bloku qapağı', 'Krank mili kasnağı', 'Balanslaşdırıcı val', 'Hava soyuducu (interkuler)', 'EGR klapanı', 'Manifold contası', 'Termostat korpusu', 'Yağ filtri korpusu', 'Mühərrik idarəetmə bloku (ECU)', 'Zamanlama zənciri', 'Zamanlama zənciri dəsti', 'Yağ ötürücü boru', 'Mühərrik yastığı kronşteyni', 'Vibrasiya udan (demfer)', 'Yağ nasosu zənciri'],
                'Əyləc sistemi': ['Ön əyləc diskləri', 'Arxa əyləc diskləri', 'Əyləc yastıqları', 'Əyləc mayesi', 'Əyləc borusu', 'Əyləc silindri', 'Əyləc kaliperi', 'ABS sensoru', 'Əyləc pedalı', 'Vakuum gücləndirici', 'Tənzimləyici klapan', 'Əyləc şlanqı', 'Əl əyləc kabeli', 'Əyləc diski qoruyucusu', 'Əyləc yastığı aşınma sensoru', 'Əl əyləc bəndi', 'Əyləc barabanı', 'ABS bloku', 'Əyləc mayesi rezervuarı', 'Əyləc yastığı bərkidici yay', 'ABS təkər sensoru halqası', 'Əyləc kaliperi bolt dəsti', 'Stop-siqnal açarı', 'Əyləc pedalı sensoru', 'Əl əyləc rıçaqı', 'Əyləc barabanı silindri', 'Əyləc kompensator klapanı', 'Elektrik əl əyləci modulu', 'Əyləc təzyiq sensoru', 'Əyləc işıq açarı', 'Əyləc pedalı yastığı', 'Əyləc mayesi qapağı', 'ESP sensoru', 'Əyləc sistemi bərkidici dəst', 'Əyləc diski cilalayıcı vərəqə', 'Əyləc kaliperi təmir dəsti', 'Əyləc borusu bağlayıcısı', 'Əyləc pedalı yayı', 'Park əyləci aktuatoru'],
                'Süspansiyon': ['Ön amortizator', 'Arxa amortizator', 'Ön qol', 'Arxa qol', 'Süspansiyon yastığı', 'Süspansiyon yayı', 'Stabilizator', 'Burç dəsti', 'Top birləşməsi', 'Ötürücü çubuq', 'Ötürücü çubuq ucu', 'Təkər rulmanı', 'Hava süspansiyon yastığı', 'Stabilizator burcu', 'Süspansiyon qolu bağlayıcısı', 'Arxa stabilizator çubuğu', 'Amortizator montaj dəsti', 'Poliuretan burc dəsti', 'Ön ox rıçaqı', 'Arxa ox rıçaqı', 'Təkər düzləndirmə tənzimləyicisi', 'Süspansiyon yayı yastığı', 'Amortizator tozluğu', 'Süspansiyon buferi', 'Ötürücü val (CV oxu)', 'CV oxu qayışı', 'Təkər göbəyi qovşağı', 'Süspansiyon kronşteyni', 'Stabilizator birləşdiricisi', 'Ön ox kəməri', 'Amortizator əks yayı', 'Süspansiyon hündürlük sensoru', 'Hava süspansiyon kompressoru', 'Təkər çıxıntı sensoru', 'Süspansiyon qolu bolt dəsti', 'Ön ox kronşteyni'],
                'Elektrik avadanlığı': ['Akkumulyator 60Ah', 'Generator', 'Starter', 'Alışma bobini', 'Gərginlik tənzimləyici', 'Siqaret çakmağı', 'Qoruyucu bloku', 'Röle', 'Batareya naqili', 'Şarj relesi', 'Şüşəsilən motoru', 'Sürət sensoru', 'Oksigen sensoru', 'Təzyiq sensoru', 'Hava axını sensoru', 'Distan idarəetmə açar başlığı', 'Mərkəzi qapanma modulu', 'ECU proqramlaşdırma modulu', 'Qapı kilidi aktuatoru', 'Pəncərə qaldırıcı düyməsi', 'Fara yuyucu motoru', 'Salon işıqlandırma açarı', 'Anten gücləndiricisi', 'Parktronik sensoru', 'Arxa görüntü kamerası', 'Yanacaq səviyyəsi göstəricisi', 'Sürət göstəricisi sensoru', 'Temperatur sensoru', 'ABS idarəetmə bloku', 'Hava yastığı sensoru', 'Hava yastığı idarəetmə bloku', 'İmmobilayzer modulu', 'Siqnalizasiya sireni', 'Mərkəzi kilid aktuatoru', 'Ventilyator relesi', 'Start-stop sistemi sensoru', 'Fara sensoru (avtomatik)', 'Yağış sensoru'],
                'Filtrlər': ['Yağ filtri', 'Hava filtri', 'Salon filtri', 'Yanacaq filtri', 'Transmissiya filtri', 'Yağ ayırıcı filtr', 'Hava filtr qutusu', 'Karbon filtri', 'Toz filtri', 'Hidravlik filtr', 'Ventilyasiya filtri', 'Yanacaq separator filtri', 'Sükan gücləndirici filtri', 'Turbina yağı filtri', 'Ventil qapağı filtri', 'Yanacaq nasosu filtri', 'Kondisioner qurutma filtri', 'İkinci mərhələ yanacaq filtri', 'Tozdan qoruyucu xüsusi filtr', 'Qış tipli hava filtri', 'Yüksək performanslı hava filtri', 'İdman hava filtri', 'Su ayırıcı yanacaq filtri', 'Yağ süzgəci contası', 'Filtr korpusu qapağı', 'Filtr açarı aləti', 'Filtr kip halqası (O-ring)', 'Kabin toz-tozan filtri'],
                'Yağlar və mayelər': ['Mühərrik yağı 5W-30', 'Mühərrik yağı 5W-40', 'Transmissiya yağı', 'Hidravlik yağ', 'Antifriz', 'Yağ əlavəsi', 'Yanacaq əlavəsi', 'Kondisioner qazı R134a', 'Sükan gücləndirici yağı', 'Şüşə yuyucu maye', 'Sürtkü yağı', 'Diferensial yağı', 'Kompressor yağı', 'Mühərrik yağı 10W-40', 'Mühərrik yağı 0W-20', 'Sintetik mühərrik yağı', 'Yarı-sintetik mühərrik yağı', 'Avtomatik sürət qutusu yağı (ATF)', 'CVT sürət qutusu yağı', 'Debriyaj hidravlik mayesi', 'Konservləşdirici yağ', 'Zəncir yağlayıcı sprey', 'Silikon qres', 'Mis əsaslı qres', 'Universal qres', 'Kondisioner kompressor yağı', 'Antikoroziya mayesi', 'Radiator təmizləyici', 'Mühərrik təmizləyici', 'İnjektor təmizləyici'],
                'İqlim sistemi': ['Kondisioner kompressoru', 'Kondensator', 'Buxarlandırıcı', 'İqlim ventili', 'Salon qızdırıcı radiatoru', 'Fan motoru', 'Fan qanadları', 'İqlim idarə paneli', 'Kondisioner şlanq dəsti', 'Qaz doldurma vanası', 'Salon istilik sensoru', 'Kondisioner klapanı elektrik dəyişdiricisi', 'İqlim sistemi radiator ventilatoru', 'Kondisioner rele bloku', 'İqlim sensoru (günəş)', 'Salon hava axını klapanı', 'Kondisioner boru birləşməsi', 'İqlim idarəetmə motoru', 'Kondisioner təzyiq sensoru', 'Buxarlandırıcı temperatur sensoru', 'Salon fan sürət tənzimləyicisi', 'İqlim sistemi filtr qutusu', 'Kondisioner kompressor qoşqu dəsti', 'İqlim sistemi vakuum aktuatoru', 'Kondisioner drenaj borusu', 'Salon qızdırıcı klapanı', 'İqlim paneli işıqlandırması', 'Kondisioner O-halqa dəsti'],
                'Egzoz sistemi': ['Katalizator', 'Egzoz manifoldu', 'Egzoz borusu', 'Səsboğucu', 'Lambda sensoru', 'Egzoz yastığı', 'Birləşdirici flans', 'Bərkidici dəsti', 'Hissəcik filtri', 'Egzoz qoruyucu ekranı', 'Orta səsboğucu', 'Arxa səsboğucu', 'Egzoz klapanı', 'Egzoz sensoru kabeli', 'Egzoz borusu bənd dəsti', 'Egzoz sistemi asma dəsti', 'Katalizator qoruyucu ekranı', 'Egzoz gaz təzyiq sensoru', 'DPF təmizləyici maye', 'Egzoz borusu adapteri', 'Egzoz manifoldu conta dəsti', 'Turbina egzoz borusu', 'Egzoz klapanı aktuatoru', 'Egzoz sistemi rezin bərkidici', 'Egzoz borusu kəsici bəndi', 'SCR modulu', 'AdBlue inyeksiya modulu', 'Egzoz temperatur sensoru'],
                'Transmissiya': ['Sürət qutusu yağı', 'Debriyaj dəsti', 'Sürət qutusu filtri', 'Sürət qutusu nasosu', 'Debriyaj pedalı', 'Sürət seçici', 'Transmissiya idarə bloku', 'CVT kəməri', 'Debriyaj diski', 'Debriyaj səbəti', 'Buraxıcı rulman', 'Sürət qutusu conta dəsti', 'Sürət qutusu solenoidi', 'Avtomat qutu radiatoru', 'Sürət qutusu sensoru', 'Diferensial dişli dəsti', 'Sürət qutusu bərkidici dəst', 'Debriyaj hidravlik silindri', 'Debriyaj master silindri', 'Sürət qutusu yağ dipstiku', 'Transmissiya montaj yastığı', 'Sürət ötürücü val', 'Sinxronizator halqası', 'Sürət qutusu qapağı', 'Ötürücü ox conta halqası', 'Avtomat qutu filtr dəsti', 'Diferensial qapağı', 'Sürət qutusu kilid mexanizmi'],
                'Təkərlər və disklər': ['Yay təkəri 205/55 R16', 'Qış təkəri 205/55 R16', 'Alüminium disk 16"', 'Polad disk 16"', 'Təkər boltları', 'Təkər qapağı', 'Təkər təzyiq sensoru', 'Təkər balans çəkisi', 'Ehtiyat təkər', 'Təkər qutusu astarı', 'Yay təkəri 195/65 R15', 'Yay təkəri 225/45 R17', 'Qış təkəri 195/65 R15', 'Bütün mövsüm təkəri 205/55 R16', 'Alüminium disk 17"', 'Alüminium disk 18"', 'Polad disk 15"', 'Təkər somunu', 'Təkər mərkəzləşdirici halqa', 'Təkər ventil klapanı', 'Təkər montaj alətləri dəsti', 'Ehtiyat təkər açarı dəsti', 'Domkrat', 'Təkər zəncirləri (qar üçün)', 'Təkər siqnal generatoru (TPMS)', 'Disk ştok bolt dəsti', 'Təkər balanslaşdırma çəkisi dəsti'],
                'Karoser hissələri': ['Ön bamper', 'Arxa bamper', 'Kapot', 'Bagaj qapağı', 'Ön qanad', 'Arxa qanad', 'Sürücü qapısı', 'Spoyler', 'Bamper amortizatoru', 'Ban bərkidici dəsti', 'Ban qoruyucu zolağı', 'Sərnişin ön qapısı', 'Arxa sol qapı', 'Arxa sağ qapı', 'Kapot qulpu', 'Bagaj qapağı qulpu', 'Kapot amortizatoru', 'Bagaj qapağı amortizatoru', 'Bamper dayağı', 'Bamper barmaqlığı', 'Kapot kilidi', 'Qapı topçası', 'Qapı kilid mexanizmi', 'Yan panel', 'Astar (təkər qutusu)', 'Bamper işıq çərçivəsi', 'Kapot izolyasiyası', 'Radiator barmaqlığı', 'Yan zolaq (molding)'],
                'İnterior aksesuarlar': ['Oturacaq örtüyü', 'Döşəmə', 'Sükan çarxı örtüyü', 'Qapı çubuğu', 'Ayaqaltı dəsti', 'Alət paneli örtüyü', 'Mərkəzi konsol', 'Salon işıqlandırma lampası', 'Təhlükəsizlik kəməri', 'Günəşlik', 'Sərnişin oturacağı', 'Sürücü oturacağı', 'Oturacaq relsi', 'Oturacaq qızdırıcı elementi', 'Salon xalçası', 'Bagaj xalçası', 'Əl dayağı (armaturka)', 'Əşya qutusu qapağı', 'Salon plastik panel dəsti', 'Sükan çarxı düyməsi', 'Uşaq oturacağı bərkidicisi (ISOFIX)', 'Salon zibil qabı', 'Stəkan tutucu', 'Salon ətirləyicisi tutacağı', 'Alət paneli üstlüyü', 'Salon tavan örtüyü', 'Bagaj şəbəkəsi', 'Salon panel bərkidici dəst'],
                'İşıqlandırma': ['Ön fara', 'Arxa lampa', 'Gündüz işıqları', 'Dönmə siqnalı', 'Arxa əks etdirici', 'Fara lampası H7', 'LED lampa dəsti', 'Fara tənzimləyicisi', 'Duman fara', 'Fara şüşəsi', 'Fara lampası H4', 'Fara lampası H1', 'Xenon lampa dəsti', 'Nömrə lövhəsi işığı', 'Bagaj işığı', 'Salon tavan işığı', 'Yan güzgü dönmə siqnalı', 'Əl əyləci işıq siqnalı', 'Duman fara lampası', 'Fara motoru (tənzimləmə)', 'Fara balaст bloku (xenon)', 'LED gündüz işığı zolağı', 'Arxa əks etdirici lampa', 'Fara qapağı (üz şüşəsi)', 'Fara bərkidici dəst', 'İşıqlandırma naqil dəsti', 'Fara soketi'],
                'Şüşələr': ['Ön şüşə', 'Arxa şüşə', 'Yan şüşə', 'Güzgü şüşəsi', 'Şüşə yapışqanı', 'Şüşə kip lenti', 'Şüşə qaldırıcı mexanizmi', 'Elektrik şüşə motoru', 'Ön sol yan şüşə', 'Ön sağ yan şüşə', 'Arxa sol yan şüşə', 'Arxa sağ yan şüşə', 'Bagaj qapağı şüşəsi', 'Günəş bacası şüşəsi (lyuk)', 'Şüşə qaldırıcı düyməsi', 'Şüşə qaldırıcı kabel dəsti', 'Ön şüşə isidici elementi', 'Şüşə silikon möhürü', 'Şüşə bərkidici klips dəsti', 'Şüşə qara zolağı (keramik)'],
                'Silecekler': ['Ön silecek çubuğu', 'Arxa silecek çubuğu', 'Silecek motoru', 'Silecek qolu', 'Silecek süngəri', 'Şüşəyuyan forsunka', 'Silecek relesi', 'Yağış sensorlu silecek çubuğu', 'Qış tipli silecek çubuğu', 'Silecek yuyucu nasosu', 'Silecek yuyucu şlanqı', 'Silecek yuyucu rezervuarı', 'Silecek qolu bərkidicisi', 'Arxa silecek motoru', 'Fara yuyucu forsunka', 'Silecek çubuğu bərkidici klips', 'Silecek keçidi (linkaj) dəsti'],
                'Yanacaq sistemi': ['Yanacaq nasosu', 'Yanacaq forsunkası', 'Yanacaq təzyiq tənzimləyicisi', 'Yanacaq bakı', 'Yanacaq şlanqı', 'Yanacaq səviyyəsi sensoru', 'Yanacaq nasosu modulu', 'Yanacaq xətti bərkidicisi', 'Yanacaq bölücüsü', 'Yanacaq bakı qapağı', 'Yanacaq borusu qoşqu dəsti', 'Yanacaq nasosu rölesi', 'Yanacaq təzyiq sensoru', 'Dizel yüksək təzyiq nasosu', 'Forsunka kip halqası dəsti', 'Yanacaq bakı ventilyasiya klapanı', 'Yanacaq xətti filtri', 'Yanacaq nasosu kip halqası', 'Yanacaq bakı asma dəsti', 'Yanacaq səviyyəsi göstərici üzgəci'],
                'Sükan sistemi': ['Sükan qutusu', 'Sükan gücləndirici nasosu', 'Sükan mili', 'Sükan çubuğu ucu', 'Sükan mailliyi tənzimləyicisi', 'Elektrik sükan modulu', 'Sükan yağı şlanqı', 'Sükan çarxı', 'Sükan qutusu kip dəsti', 'Sükan gücləndirici rezervuarı', 'Sükan mili birləşməsi', 'Sükan sensoru (bucaq)', 'Sükan sütunu', 'Sükan sütunu kilidi', 'Sükan çubuğu (rulevoy)', 'Sükan gücləndirici kəməri', 'Sükan qutusu bərkidici dəst', 'Sükan yastığı (airbag)'],
                'Güzgü və xarici aksesuarlar': ['Yan güzgü (sol)', 'Yan güzgü (sağ)', 'Güzgü qızdırıcı elementi', 'Elektrik güzgü tənzimləyici motoru', 'Daxili salon güzgüsü', 'Güzgü qapağı', 'Radio anteni', 'Bagaj çubuğu', 'Güzgü şüşəsi (isti)', 'Qatlanan güzgü mexanizmi', 'Güzgü dönmə siqnalı lampası', 'Salon güzgüsü antiblik (avtomatik qaralan)', 'Güzgü bərkidici kronşteyn', 'Xarici antena bazası', 'Dam relingi bərkidicisi', 'Skiforması yük daşıyıcısı', 'Arxa spoyler bərkidicisi'],
            };

            // ===== BAZAR QİYMƏTLƏRİ (AZN) — Bakı bazarı araşdırmasına əsasən =====
            const basePriceRanges = {
                'Mühərrik hissələri': [15, 130], 'Əyləc sistemi': [20, 150], 'Süspansiyon': [15, 180],
                'Elektrik avadanlığı': [12, 190], 'Filtrlər': [8, 32], 'Yağlar və mayelər': [8, 45],
                'İqlim sistemi': [22, 200], 'Egzoz sistemi': [20, 160], 'Transmissiya': [20, 200],
                'Təkərlər və disklər': [25, 190], 'Karoser hissələri': [40, 350], 'İnterior aksesuarlar': [10, 100],
                'İşıqlandırma': [12, 200], 'Şüşələr': [30, 260], 'Silecekler': [8, 40],
                'Yanacaq sistemi': [20, 220], 'Sükan sistemi': [35, 350], 'Güzgü və xarici aksesuarlar': [18, 130]
            };
            const premiumPriceRanges = {
                'Mühərrik hissələri': [180, 480], 'Əyləc sistemi': [180, 350], 'Süspansiyon': [200, 420],
                'Elektrik avadanlığı': [180, 320], 'İqlim sistemi': [220, 420], 'Egzoz sistemi': [180, 350],
                'Transmissiya': [220, 480], 'Karoser hissələri': [400, 750], 'İşıqlandırma': [220, 280],
                'Şüşələr': [260, 380], 'Yanacaq sistemi': [230, 350], 'Sükan sistemi': [360, 480]
            };
            const premiumKeywords = ['mühərrik bloku', 'krank mili', 'piston', 'silindr başlığı', 'sürət qutusu',
                'debriyaj səbəti', 'debriyaj dəsti', 'katalizator', 'kondisioner kompressoru', 'ön şüşə', 'arxa şüşə',
                'kapot', 'bagaj qapağı', 'ön bamper', 'arxa bamper', 'sükan qutusu', 'sükan gücləndirici nasosu',
                'yanacaq nasosu', 'egzoz manifoldu', 'abs bloku', 'akkumulyator', 'generator', 'sürücü qapısı'];

            function realisticPrice(cat, partName) {
                const [lo, hi] = basePriceRanges[cat] || [10, 100];
                const isPremium = premiumKeywords.some(k => partName.toLowerCase().includes(k));
                const [plo, phi] = (isPremium && premiumPriceRanges[cat]) ? premiumPriceRanges[cat] : [lo, hi];
                return Math.round((plo + Math.random() * (phi - plo)) * 10) / 10;
            }
            ...
            categories.forEach(cat => {
                ...
                for (let i = 0; i < 45; i++) {
                    ...
                    const year = (modelYears && modelYears.length)
                        ? modelYears[Math.floor(Math.random() * modelYears.length)]
                        : (2005 + Math.floor(Math.random() * 21));
                    const price = realisticPrice(cat, name);
...
<body onload="window.print();">
    ...
    <div class="center footer">Xoş gəldiniz!<br>Təkrar gözləyirik.</div>
        ...
        function initApp() {
            ...
            const CATALOG_VERSION = '6'; // v6 = hər kateqoriyaya +20 real mal (~500 unikal ad, ~810 məhsul)
            state.products = loadFromStorage('products');
            const catalogV = localStorage.getItem('autoparts_catalog_v');
            if (state.products.length === 0 || state.products.length < 700 || catalogV !== CATALOG_VERSION) {
